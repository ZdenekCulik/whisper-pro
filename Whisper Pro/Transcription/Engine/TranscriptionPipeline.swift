...
class TranscriptionPipeline {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "TranscriptionPipeline")
            ...
            if transcription.transcriptionStatus == TranscriptionStatus.completed.rawValue {
                ...
                do {
                    didInsertSessionMetric = try SessionMetricRecorder.recordRecorderSession(
                        ...
                        model: model,
                        in: modelContext,
                        appName: dictatedApp?.localizedName,
                        appBundleId: dictatedApp?.bundleIdentifier
                    )
                } catch {
