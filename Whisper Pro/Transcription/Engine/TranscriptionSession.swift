...
final class FileTranscriptionSession: TranscriptionSession {
    ...
    func transcribe(audioURL: URL) async throws -> String {
        guard let model = model else {
            throw WhisperProEngineError.transcriptionFailed
        }
...
final class StreamingTranscriptionSession: TranscriptionSession {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "StreamingTranscriptionSession")
