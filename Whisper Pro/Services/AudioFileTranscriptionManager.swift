...
class AudioTranscriptionManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "AudioTranscriptionManager")
    ...
    func startProcessing(modelContext: ModelContext, engine: WhisperProEngine, mode: ModeConfig) {
    ...
    private func processItem(_ item: AudioFileQueueItem, modelContext: ModelContext, engine: WhisperProEngine, mode: ModeConfig) async {
