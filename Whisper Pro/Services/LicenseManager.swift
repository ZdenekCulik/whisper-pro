...
final class LicenseManager {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "LicenseManager")

    private let licenseKeyIdentifier = "whisperpro.license.key"
    private let trialStartDateIdentifier = "whisperpro.license.trialStartDate"
    private let activationIdIdentifier = "whisperpro.license.activationId"
