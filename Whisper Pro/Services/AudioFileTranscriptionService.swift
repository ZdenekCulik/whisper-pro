...
class AudioTranscriptionService: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "AudioTranscriptionService")
    ...
    init(modelContext: ModelContext, engine: WhisperProEngine) {
