...
final class LogExporter {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "LogExporter")
    private let subsystem = "com.prakashjoshipax.whisperpro"
    ...
    private func fetchLogs() async throws -> [String] {
        ...
        logLines.append("=== Whisper Pro Diagnostic Logs ===")
    ...
    private func saveLogsToFile(_ logs: [String]) throws -> URL {
        ...
        let fileName = "Whisper Pro Logs \(timestamp).log"
