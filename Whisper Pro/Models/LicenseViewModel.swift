...
class LicenseViewModel: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "LicenseViewModel")
    ...
    private func loadLicenseState() {
        ...
        if let storedLicenseKey = licenseManager.licenseKey {
            ...
            if licenseManager.activationId != nil || !userDefaults.bool(forKey: "WhisperProLicenseRequiresActivation") {
                licenseState = .licensed
            ...
            if licenseCheck.requiresActivation {
                ...
                if let existingActivationId = licenseManager.activationId {
                    ...
                    if isValid {
                        ...
                        userDefaults.set(true, forKey: "WhisperProLicenseRequiresActivation")
                ...
                licenseManager.licenseKey = normalizedLicenseKey
                licenseManager.activationId = nil
                userDefaults.set(false, forKey: "WhisperProLicenseRequiresActivation")
...
extension UserDefaults {
    var activationsLimit: Int {
        get { integer(forKey: "WhisperProActivationsLimit") }
        set { set(newValue, forKey: "WhisperProActivationsLimit") }
    }
}
