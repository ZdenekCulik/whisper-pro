...
enum OnboardingExperienceCatalog {
    static let steps: [OnboardingExperienceStep] = [
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Turn your spoken note into a clean email draft with Whisper Pro.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            title: "Try Rewrite",
            subtitle: "Select the text on the screen, tell Whisper Pro the changes you want, and Whisper Pro will rewrite the text for you.",
            sampleLabel: "Sample text",
        ...
        OnboardingExperienceStep(
            ...
            subtitle: "Ask quick questions and Whisper Pro will serve you the answers.",
