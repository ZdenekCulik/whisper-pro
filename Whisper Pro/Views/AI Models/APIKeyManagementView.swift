        ...
        Section("AI Provider Integration") {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                if aiService.selectedProvider == .ollama {
                    ...
                    Text("Environment variables available: WHISPERPRO_SYSTEM_PROMPT, WHISPERPRO_USER_PROMPT, WHISPERPRO_FULL_PROMPT. Whisper Pro also writes WHISPERPRO_FULL_PROMPT to stdin for every command.")
                        .font(.caption)
                        .foregroundColor(.secondary)
