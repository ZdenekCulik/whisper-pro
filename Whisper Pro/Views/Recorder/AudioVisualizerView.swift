...
struct AudioVisualizer: View {
    ...
    private func barHeight(for index: Int, at date: Date) -> CGFloat {
        ...
        // React to the live audio level only: silent → bars settle flat, speaking →
        // they rise. Use whichever of average/peak is stronger so quiet/processed mic
        // signals still register.
