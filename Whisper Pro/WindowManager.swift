...
class WindowManager: NSObject {
    ...
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("com.prakashjoshipax.whisperpro.mainWindow")
    private static let mainWindowAutosaveName = NSWindow.FrameAutosaveName("WhisperProMainWindowFrame")

    private let logger = Logger(subsystem: "com.prakashjoshipax.whisperpro", category: "WindowManager")
